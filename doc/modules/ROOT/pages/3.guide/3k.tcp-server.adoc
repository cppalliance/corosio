...
* xref:3d.sockets.adoc[Sockets] — Socket operations
* xref:3b.concurrent-programming.adoc[Concurrent Programming] — Coroutine patterns
* xref:../2.tutorials/2a.echo-server.adoc[Echo Server Tutorial] — Simpler approach
