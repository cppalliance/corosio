...
See xref:3g.composed-operations.adoc[Composed Operations] for details.
...
See xref:3n.buffers.adoc[Buffer Sequences] for details.
...
* xref:3e.tcp-acceptor.adoc[Acceptors] — Accept incoming connections
* xref:3f.endpoints.adoc[Endpoints] — IP addresses and ports
* xref:3g.composed-operations.adoc[Composed Operations] — read() and write()
* xref:../2.tutorials/2a.echo-server.adoc[Echo Server Tutorial] — Server example
