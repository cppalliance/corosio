...
* xref:3g.composed-operations.adoc[Composed Operations] — Using buffers with read/write
* xref:3d.sockets.adoc[Sockets] — Socket I/O operations
* xref:../2.tutorials/2a.echo-server.adoc[Echo Server Tutorial] — Practical usage
