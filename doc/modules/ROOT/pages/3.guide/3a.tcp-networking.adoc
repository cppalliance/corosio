...
* xref:3b.concurrent-programming.adoc[Concurrent Programming] — Coroutines and strands
* xref:3c.io-context.adoc[I/O Context] — The event loop
* xref:3d.sockets.adoc[Sockets] — Socket operations in detail
