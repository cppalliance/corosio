...
* xref:3d.sockets.adoc[Sockets] — The underlying stream interface
* xref:3n.buffers.adoc[Buffer Sequences] — Working with buffers
* xref:../2.tutorials/2b.http-client.adoc[HTTP Client Tutorial] — Practical example
