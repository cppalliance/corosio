...
See xref:../4.concepts/4b.affine-awaitables.adoc[Affine Awaitables] for details.
...
xref:3k.tcp-server.adoc[TCP Server] for details.
...
* xref:3c.io-context.adoc[I/O Context] — The event loop in detail
* xref:../4.concepts/4b.affine-awaitables.adoc[Affine Awaitables] — How affinity propagates
* xref:../2.tutorials/2a.echo-server.adoc[Echo Server] — Practical concurrency example
