...
* xref:../3.guide/3j.resolver.adoc[Resolver Guide] — Full resolver reference
* xref:../3.guide/3f.endpoints.adoc[Endpoints Guide] — Working with addresses
* xref:2b.http-client.adoc[HTTP Client] — Use resolved addresses for connections
