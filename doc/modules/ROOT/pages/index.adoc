...
If you're new to these topics, see xref:3.guide/3a.tcp-networking.adoc[TCP/IP Networking]
and xref:3.guide/3b.concurrent-programming.adoc[Concurrent Programming] for background.
...
* xref:3.guide/3a.tcp-networking.adoc[TCP/IP Networking] — Networking fundamentals
* xref:3.guide/3b.concurrent-programming.adoc[Concurrent Programming] — Coroutines and strands
* xref:3.guide/3c.io-context.adoc[I/O Context] — Understand the event loop
* xref:3.guide/3d.sockets.adoc[Sockets] — Learn socket operations in detail
