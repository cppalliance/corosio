...
* xref:../3.guide/3d.sockets.adoc[Sockets Guide] — The socket interface mockets implement
* xref:../3.guide/3m.error-handling.adoc[Error Handling] — Testing error paths
