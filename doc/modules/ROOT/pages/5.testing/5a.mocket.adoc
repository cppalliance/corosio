...
See xref:5c.patterns.adoc[Testing Patterns] for a TLS-over-mocket
example.
...
* xref:5b.socket-pair.adoc[Socket Pairs] — when you need real socket
  semantics instead of staged bytes.
* xref:5c.patterns.adoc[Testing Patterns] — recipes that combine mocket,
