...
This page collects recipes that combine xref:5a.mocket.adoc[`mocket`]
and xref:5b.socket-pair.adoc[`make_socket_pair`] in realistic test
...
* xref:5a.mocket.adoc[Mock Sockets]
* xref:5b.socket-pair.adoc[Socket Pairs]
