...
* xref:../3.guide/3c.io-context.adoc[I/O Context] — The execution context
* xref:../3.guide/3m.error-handling.adoc[Error Handling] — Cancellation patterns
* xref:4a.design-rationale.adoc[Design Rationale] — Why this design
