...
* xref:3.guide/3k.tcp-server.adoc[TCP Server Guide] — Deep dive into tcp_server
...
* xref:2.tutorials/2b.http-client.adoc[HTTP Client Tutorial] — Make HTTP requests
* xref:3.guide/3c.io-context.adoc[I/O Context Guide] — Understand the event loop
* xref:3.guide/3d.sockets.adoc[Sockets Guide] — Deep dive into socket operations
