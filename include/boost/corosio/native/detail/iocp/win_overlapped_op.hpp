...
iocp_make_err(DWORD dwError, bool accept_path) noexcept
{
    ...
    if (dwError == ERROR_NETNAME_DELETED)
        return std::make_error_code(
            accept_path ? std::errc::connection_aborted
